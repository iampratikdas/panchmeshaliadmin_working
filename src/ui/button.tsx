...
const buttonVariants = cva(
    'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
    {
        variants: {
            variant: {
                default: 'glass text-primary-foreground hover:brightness-110 shadow-lg',
                destructive:
                    'bg-destructive/90 text-destructive-foreground hover:bg-destructive backdrop-blur-sm',
                outline:
                    'glass-card border-white/40 hover:brightness-105',
                secondary:
                    'glass-card hover:brightness-105',
                ghost: 'hover:bg-white/20 hover:backdrop-blur-md',
